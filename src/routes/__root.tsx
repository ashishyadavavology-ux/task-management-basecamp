...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Basecamp Project Management is a warm, calm workspace for teams — kanban boards, chat, calendars and collaboration." },
      { name: "author", content: "Basecamp Project Management" },
      { property: "og:title", content: "Basecamp — Project management for modern teams" },
      { property: "og:description", content: "Kanban boards, real-time collaboration and calm project management." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Basecamp — Project management for modern teams" },
